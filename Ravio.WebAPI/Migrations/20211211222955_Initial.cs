        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodResultEntityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Food", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Food_FoodResults_FoodResultEntityId",
                        column: x => x.FoodResultEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Food_FoodResultEntityId",
                table: "Food",
                column: "FoodResultEntityId");
